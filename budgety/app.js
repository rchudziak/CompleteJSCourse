//Use IIFE and closures to create a module pattern
...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            //Calculate the budger: income - expenses
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var setupEventListeners = function () {
        ...
        //Add keypress event listener on the global document, because it does not happen on any particular element but globally
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 2. Add the item tot he budget controller
